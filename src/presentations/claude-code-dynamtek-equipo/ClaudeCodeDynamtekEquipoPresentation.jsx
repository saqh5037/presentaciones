...
import './ClaudeCodeDynamtekEquipo.css'
...
function ClaudeCodeDynamtekEquipoPresentation() {
              ...
              <div style={{ padding: '16px', borderBottom: '1px solid #e5e7eb' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
                  <div>
                    ...
                    <p style={{ color: '#6b7280', fontSize: '12px', marginTop: '4px' }}>Dynamtek Presentation</p>
                  </div>
                  <button
                    onClick={() => setShowSidebar(false)}
                    style={{
...
export default ClaudeCodeDynamtekEquipoPresentation