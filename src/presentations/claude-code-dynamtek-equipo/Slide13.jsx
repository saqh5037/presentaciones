...
function Slide13() {
  ...
  const actions = [
    {
      title: "Bienvenidos a la nueva era de desarrollo en Dynamtek",
      icon: Play
    },
    {
      ...
      >
        ...
        >
          ...
          <p style={{
            ...
            Dynamtek adopta Claude Code como su asistente de IA
          </p>
        </motion.div>
        ...
        >
          ...
          >
            Dynamtek + Claude Code = Desarrollo 10x
          </motion.p>
        </motion.div>
