...
function MusiExportDocumentV2() {
   ...
   */
  const handleBack = () => {
    navigate('/presentation/musi-kickoffV2')
  }
        ...
        <div className="document-content">
          ...
          <div className="document-page">
            ...
            <div className="doc-info">
              <p><strong>Cliente:</strong> Musi / Musmanni (FIFCO)</p>
          ...
          <div className="document-page">
            ...
            <div className="doc-section">
              ...
              es crucial para maximizar ventas y mejorar la experiencia del cliente. Musi y Musmanni 
          ...
          <div className="document-page">
            ...
            <div className="objective-box">
              ...
              comerciales que permita a Musi y Musmanni <strong>optimizar la distribución</strong> de 
...
export default MusiExportDocumentV2